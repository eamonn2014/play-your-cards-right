...
In this app a Jack is represented by the card value 10 when using 13 for the 'number of cards of each suit in deck' a regular deck of cards is created. Ignore the app for now and 
